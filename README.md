...
See the [Installation Guide](https://secret-manager-controller.microscaler.io/getting-started/installation) for detailed setup instructions.
...
### Getting Started
- [Installation](https://secret-manager-controller.microscaler.io/getting-started/installation) - Deploy to your Kubernetes cluster
- [Quick Start](https://secret-manager-controller.microscaler.io/getting-started/quick-start) - Create your first SecretManagerConfig
- [Configuration](https://secret-manager-controller.microscaler.io/getting-started/configuration) - Configure your cloud provider

### Key Guides
- [Architecture Overview](https://secret-manager-controller.microscaler.io/architecture/overview) - Understand how it works
- [Serverless Integration](https://secret-manager-controller.microscaler.io/architecture/serverless-integration) - Deploy to CloudRun, Lambda, Functions
- [GitOps Integration](https://secret-manager-controller.microscaler.io/guides/gitops-integration) - Integrate with FluxCD or ArgoCD
- [SOPS Setup](https://secret-manager-controller.microscaler.io/guides/sops-setup) - Encrypt secrets in Git

### Provider Setup
- [GCP Setup](https://secret-manager-controller.microscaler.io/guides/gcp-setup) - Google Cloud Platform configuration
- [AWS Setup](https://secret-manager-controller.microscaler.io/guides/aws-setup) - Amazon Web Services configuration
- [Azure Setup](https://secret-manager-controller.microscaler.io/guides/azure-setup) - Microsoft Azure configuration

### API Reference
- [CRD Reference](https://secret-manager-controller.microscaler.io/api-reference/crd-reference) - Complete CRD documentation
- [Configuration Options](https://secret-manager-controller.microscaler.io/api-reference/configuration-options) - All configuration parameters
- [Provider APIs](https://secret-manager-controller.microscaler.io/api-reference/provider-apis) - Cloud provider API details

### CLI Tool
- [MSMCTL CLI](https://secret-manager-controller.microscaler.io/guides/msmctl-cli) - Command-line tool for managing the controller
...
**Questions?** Check out our [troubleshooting guide](https://secret-manager-controller.microscaler.io/tutorials/troubleshooting) or explore the full [documentation site](https://secret-manager-controller.microscaler.io).
