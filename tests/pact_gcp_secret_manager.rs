...
async fn test_gcp_list_secret_versions_contract() {
    ...
    let mock_url = format!(
        "{}/v1/projects/test-project/secrets/test-secret-name/versions",
        base_url
    );
...
async fn test_gcp_delete_secret_contract() {
    ...
    let mock_url = format!(
        "{}/v1/projects/test-project/secrets/test-secret-name",
        base_url
    );
...
async fn test_gcp_disable_secret_version_contract() {
    ...
    let mock_url = format!(
        "{}/v1/projects/test-project/secrets/test-secret-name/versions/1:disable",
        base_url
    );
...
async fn test_gcp_enable_secret_version_contract() {
    ...
    let mock_url = format!(
        "{}/v1/projects/test-project/secrets/test-secret-name/versions/1:enable",
        base_url
    );
...
async fn test_gcp_destroy_secret_version_contract() {
    ...
    let mock_url = format!(
        "{}/v1/projects/test-project/secrets/test-secret-name/versions/1:destroy",
        base_url
    );
